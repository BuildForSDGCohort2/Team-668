...
class QuickReply:
    ...
    def to_dict(self):
        reply_dict = {
            CONTENT_TYPE_FIELD: self.content_type.value,
...
class Messager(object):
    ...
    def set_greeting_text(self, text):
        ...
        return requests.post(
            fmt.format(token=self.access_token),
    ...
    def send_quick_replies(self, user_id, title, reply_list):
        ...
        self._send(
            {
                RECIPIENT_FIELD: self._build_recipient(user_id),
                MESSAGE_FIELD: {TEXT_FIELD: title, QUICK_REPLIES_FIELD: replies},
            }
        )
